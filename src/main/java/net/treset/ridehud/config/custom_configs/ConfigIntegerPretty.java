package net.treset.ridehud.config.custom_configs;
...
public class ConfigIntegerPretty extends ConfigBase<ConfigInteger> implements IConfigInteger {
    ...
    public ConfigIntegerPretty(String name, int defaultValue, String comment, String prettyName)
    {
        this(name, defaultValue, Integer.MIN_VALUE, Integer.MAX_VALUE, comment, prettyName);
    }

    public ConfigIntegerPretty(String name, int defaultValue, int minValue, int maxValue, String comment, String prettyName)
    {
        this(name, defaultValue, minValue, maxValue, false, comment, prettyName);
    }

    public ConfigIntegerPretty(String name, int defaultValue, int minValue, int maxValue, boolean useSlider, String comment, String prettyName)
    {
