...
public class DonkeyStats extends VehicleStats {
    ...
    public DonkeyStats(DonkeyEntity donkey) {
        ...
        this.speedMin = 4.86;
        this.speedMax = 14.57;
        this.speedModifier = donkey.getMovementSpeed();
    ...
    public void updateSpeed() {
        this.speedModifier = this.donkey.getMovementSpeed();
        this.speed = this.speedModifier * 43.17;
        this.speedScore = (int)((this.speed - speedMin) / (speedMax - speedMin) * 100);
    }
}
